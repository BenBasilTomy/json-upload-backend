...
const allowedOrigins = ['https://benbasiltomy.github.io/cavili-front/','http://quiz.nexcode.in/cavili-front/','https://benbasiltomy.github.io', 'http://localhost:3000', 'http://localhost:3001'];
app.use(cors({
